...
sbatch_to_slurm = [
    ...
    SbatchToSlurm("memory_per_node", "--mem", "", dict(type=int)),
    SbatchToSlurm("memory_binding", "--mem-bind"),
    SbatchToSlurm("memory_per_cpu", "--mem-per-cpu", "", dict(type=int)),
    SbatchToSlurm("memory_per_gpu", "--mem-per-gpu", "", dict(type=int)),
    ...
    SbatchToSlurm("time_limit", "--time", "-t", dict(type=int)),
    SbatchToSlurm("time_minimum", "--time-min", dict(type=int)),
    SbatchToSlurm("", "--tmp"),
    SbatchToSlurm("", "--uid"),
