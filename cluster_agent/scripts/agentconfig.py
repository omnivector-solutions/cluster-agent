...
PARAM_KEYS = (
    ...
    "CLUSTER_AGENT_AUTH0_DOMAIN",
    "CLUSTER_AGENT_AUTH0_AUDIENCE",
    "CLUSTER_AGENT_AUTH0_CLIENT_ID",
    "CLUSTER_AGENT_AUTH0_CLIENT_SECRET",
)
...
PARAM_TEMPLATE = inspect.cleandoc(
    ...
    CLUSTER_AGENT_AUTH0_DOMAIN = {CLUSTER_AGENT_AUTH0_DOMAIN!a}
    CLUSTER_AGENT_AUTH0_AUDIENCE = {CLUSTER_AGENT_AUTH0_AUDIENCE!a}
    CLUSTER_AGENT_AUTH0_CLIENT_ID = {CLUSTER_AGENT_AUTH0_CLIENT_ID!a}
    CLUSTER_AGENT_AUTH0_CLIENT_SECRET = {CLUSTER_AGENT_AUTH0_CLIENT_SECRET!a}
    """
)
...
def read_upstream():
    ...
    defaults = dict(
        ...
        CLUSTER_AGENT_AUTH0_DOMAIN="https://auth-domain.com",
        CLUSTER_AGENT_AUTH0_AUDIENCE="https://armada.omnivector.solutions",
        CLUSTER_AGENT_AUTH0_CLIENT_ID="abcde12345",
        CLUSTER_AGENT_AUTH0_CLIENT_SECRET="abcde12345",
    )
