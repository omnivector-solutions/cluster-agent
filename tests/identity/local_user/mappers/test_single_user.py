...
from cluster_agent.identity.local_user.mappers import single_user
...
def test_find_username__fails_mapper_is_not_configured(mocker, tweak_local_user_settings):
    """
